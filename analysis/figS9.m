...
% A/B/C/D Label
hA = text(mar+1.5*sep,(n-1)*(hei+sep)+hei+mar,'A','Units','Pixels');
hA.Color = 'w';
hA.FontWeight = 'bold';
hA.FontSize = 16;

hB = text(mar+1.5*sep,(n-2)*(hei+sep)+hei+mar,'B','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 16;

hC = text(mar+1.5*sep,(n-3)*(hei+sep)+hei+mar,'C','Units','Pixels');
hC.Color = 'w';
hC.FontWeight = 'bold';
hC.FontSize = 16;

hC = text(mar+1.5*sep,(n-3)*(hei+sep)-sep+hei+mar,'\tau = 0','Units','Pixels');
hC.Color = 'w';
hC.FontWeight = 'bold';
hC.FontSize = 12;
...
hD = text(mar+1.5*sep,(n-4)*(hei+sep)-1.35*sep+hei+mar,'\tau = 0','Units','Pixels');
hD.Color = 'k';
hD.FontWeight = 'bold';
hD.FontSize = 12;
...
print('Fig_S9/ColonyModel_ImportanceOfLatency.tif','-dtiff')