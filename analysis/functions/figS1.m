...
hB = text(mar+1.5*sep,(n-1)*(hei+sep)-sep+hei+mar,'l = 10^3 {\mu}m','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 10;
...
hB = text(mar+1.5*sep,(n-2)*(hei+sep)-sep+hei+mar,'l = 400 {\mu}m','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 10;
...
hC = text(mar+1.5*sep,(n-3)*(hei+sep)-sep+hei+mar,'l = 200 {\mu}m','Units','Pixels');
hC.Color = 'k';
hC.FontWeight = 'bold';
hC.FontSize = 10;
