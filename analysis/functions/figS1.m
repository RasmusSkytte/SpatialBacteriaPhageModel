...
%             ax(I).XTick(end) = ax(I).XTick(end)-0.5;
        ...
        if i == 1
            title(sprintf('l = %d {\\mu}m',1e4/nGrid(j)),'FontWeight','Normal')
        end
    end
end
...
% A/B/C/D Label
hA = text(mar+1.2*sep,3*(hei+sep)+hei+mar+0.5*sep,'Model 4','Units','Pixels');
hA.Color = 'k';
hA.FontWeight = 'bold';
hA.FontSize = 16;
...
hB = text(mar+1.2*sep,2*(hei+sep)+hei+mar+0.5*sep,'Model 4','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 16;
...
hC = text(mar+1.2*sep,(hei+sep)+hei+mar+0.5*sep,'Model 4','Units','Pixels');
hC.Color = 'k';
hC.FontWeight = 'bold';
hC.FontSize = 16;
...
hD = text(mar+1.2*sep,hei+mar+0.5*sep,'Model 4','Units','Pixels');
hD.Color = 'k';
hD.FontWeight = 'bold';
hD.FontSize = 16;
