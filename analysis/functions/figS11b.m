...
path = [path '/Experiment_Conditions/beta_400_delta_0.003_eta_13200_tau_1.00_D_P_10000_nGrid_100_boundaryModifier_10'];
...
% Change the label
tx.String = 'D_P = 10000 {\mu}m^2/h';
tx.Position(1) = 1.0;
tx.Position(2) = 1.0;


if ~exist('../Fig_S11','dir')
    mkdir('../Fig_S11')
end
print('-r400','../Fig_S11/lower.tif','-dtiff')
