...
hB = text(mar+1.5*sep,(n-1)*(hei+sep)-sep+hei+mar,'\zeta = 1','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 10;
...
hB = text(mar+1.5*sep,(n-2)*(hei+sep)-sep+hei+mar,'\zeta = 10','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 10;
...
print(fh,'../Fig_S4/FigS4.tif','-dtiff')