...
% A/B/C/D Label
hA = text(mar+1.5*sep,(n-1)*(hei+sep)+hei+mar,'Model 4','Units','Pixels');
hA.Color = 'k';
hA.FontWeight = 'bold';
hA.FontSize = 16;

hB = text(mar+1.5*sep,(n-2)*(hei+sep)+hei+mar,'Model 4','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 16;

hB = text(mar+1.2*sep,(n-2)*(hei+sep)-sep+hei+mar,'- Clustering','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 10;
...
hC = text(mar+1.2*sep,(n-3)*(hei+sep)-sep+hei+mar,'- Shielding','Units','Pixels');
hC.Color = 'k';
hC.FontWeight = 'bold';
hC.FontSize = 10;
...
hD = text(mar+1.2*sep, (n-4)*(hei+sep)-sep+hei+mar,'- Readsorb','Units','Pixels');
hD.Color = 'k';
hD.FontWeight = 'bold';
hD.FontSize = 10;
