...
% Prepare figure
fh = figure();
fh.Position = [1500 -250 3*wid+2*mar+3*sep+sep 2*hei+2*mar+2*sep];
...
hA = text(mar+1.2*sep,hei+mar-sep+0.6*sep,'l = 0.2 mm','Units','Pixels');
hA.Color = 'k';
hA.FontWeight = 'bold';
hA.FontSize = 10;
...
print('Fig_S8/ColonyModel_effectOfSpace.tif','-dtiff')