...
for i = 1:2
    ...
    % Load data
    subpaths = dir(sprintf('%s/Model_%d',path,i+3));
...
hB = text(mar+1.5*sep,(n-2)*(hei+sep)-sep+hei+mar,'\zeta = 5','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 10;
...
print('Fig_S4/ColonyModel_InfluenceOfZeta.tif','-dtiff')