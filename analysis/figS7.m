...
hA = text(mar+1.5*sep,(n-2)*(hei+sep)+hei+mar,'D','Units','Pixels');
hA.Color = 'k';
hA.FontWeight = 'bold';
hA.FontSize = 16;
...
hB = text(mar+1.5*sep,(n-3)*(hei+sep)+hei+mar,'D','Units','Pixels');
hB.Color = 'k';
hB.FontWeight = 'bold';
hB.FontSize = 16;
...
hC = text(mar+1.5*sep, (n-4)*(hei+sep)+hei+mar,'D','Units','Pixels');
hC.Color = 'k';
hC.FontWeight = 'bold';
hC.FontSize = 16;
...
print('Fig_S7/ColonyModel_RemovingSingleMechanism.tif','-dtiff')
